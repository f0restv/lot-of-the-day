...
function getTimeUntilMidnight() {
  ...
  const nextMidnightZoned = addDays(startOfDay(zonedNow), 1);
  const nextMidnightUtc = fromZonedTime(nextMidnightZoned, TIMEZONE);
  const diff = Math.max(0, nextMidnightUtc.getTime() - now.getTime());
