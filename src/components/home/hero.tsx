    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
        ...
        >
          <Link
            href={`/lot/${lot.date}`}
            className="inline-flex items-center gap-2 bg-gold text-background px-10 py-4 text-sm tracking-wider uppercase font-bold hover:bg-gold-dark transition-colors duration-300"
          >
            View This Lot
            <svg
              width="16"
